...
namespace SQLiteWp8._1.Views
{
    ...
    {
        ObservableCollection<Receipt> DB_ContactList = new ObservableCollection<Receipt>();
        ...
        private void listBoxobj_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {
            ...
            {
                Receipt listitem = listBoxobj.SelectedItem as Receipt;//Get slected listbox item contact ID 
